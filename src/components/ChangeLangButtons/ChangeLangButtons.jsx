...
const ChangeLangButtons = () => {
	...
	return (
		<div className='flex justify-between items-center gap-4 absolute right-10'>
			<button
				onClick={() => changeLang('ru')}
				className={cn('grayscale transition-all duration-300 hover:grayscale-0', { 'grayscale-0': i18n.language === 'ru' })}
			>
			...
			<button
				...
				className={cn('grayscale transition-all duration-300 hover:grayscale-0', { 'grayscale-0': i18n.language === 'en' })}
			>
				<svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 32 32'>
